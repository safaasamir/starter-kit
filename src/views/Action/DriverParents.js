...
import DriverParentTable from '../tables/DriverParentTable'
function DriverParent() {
    ...
    return (
        ...
        <DriverParentTable onsubmit={handleSearch} onclick={handleReset} setvalue={setValue} values={value} dataTable={data} prev={renderPagination()}/>

    );
}

export default DriverParent;
