...
function DriverMap()
{
    ...
    return(
            ...
            <div className='invoice-list-table-header w-100 me-1 ms-10 mt-0 mb-30 '>
                <Row>
                    <Col xl='6' className='d-flex align-items-center p-1 '>
                        ...
                        <h2 style={{ color: "black" , marginTop:"10px",marginLeft:"10px"}}>parent Location</h2>
                    ...
                    <h3 style={{ color: "black" ,marginLeft:"25px" }}> parent Name : </h3>
                    </Col>
        ...
        <div className='address'><h3> Parent address :</h3></div>
